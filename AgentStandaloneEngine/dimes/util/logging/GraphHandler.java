...
public class GraphHandler extends ConsoleHandler
{
	...
	public GraphHandler(AgentFrame aFrame)
	{
		frame = aFrame;
	}
	...
	public void publish(LogRecord log)
	{
		...
		try
		{
			logDoc = DocumentHelper.parseText(msg);
		}
		...
		Element logRoot = logDoc.getRootElement();
		String command = logRoot.elementTextTrim("CommandType");
