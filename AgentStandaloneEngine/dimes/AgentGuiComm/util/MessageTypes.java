...
//-------------------------------------------------------------------------------------
	...
	public static final String SENT_TYPE_STATUS="STATUS";
	public static final List<String> SEND_TYPES_ARRAY = new ArrayList<String>(Arrays.asList(new String[]{SEND_TYPE_RESULTS,SEND_TYPE_SCRIPT,SEND_TYPE_LOG,SEND_TYPE_PROPERTY,SEND_TYPE_DIMES, SEND_TYPE_SHOW, SENT_TYPE_STATUS}));
...
//----------------------------------------------------------------------------------------
	...
	public static final int SCRIPT_ACTION_NO_ACTION = -1;
	public static final int SCRIPT_ACTION_LOAD_FILE_ACTION = 1;
	public static final int SCRIPT_ACTION_LOAD_URL_ACTION = 2;
	public static final int SCRIPT_ACTION_CRAWL_URL_ACTION = 3;
	public static final int SCRIPT_ACTION_RAW_SCRIPT_ACTION = 4;
	 ...
	 * note that these have corrosponding entries in the lookup table
	 * 
	 */
...
//------------------------------------------
	...
	static{
		 ...
		 lookup.put("LOADFILE", SCRIPT_ACTION_LOAD_FILE_ACTION);
		 lookup.put("LOADURL", SCRIPT_ACTION_LOAD_URL_ACTION);
		 lookup.put("CRAWLURL", SCRIPT_ACTION_LOAD_URL_ACTION);
		 lookup.put("RAWSCRIPT", SCRIPT_ACTION_RAW_SCRIPT_ACTION);
		 
		 lookup.put("PING", MeasurementType.PING);
		 lookup.put("TRACEROUTE", MeasurementType.TRACEROUTE);
		 lookup.put("PARISTRACEROUTE", MeasurementType.PARIS_TRACEROUTE);
		 lookup.put("QBE", MeasurementType.QBE);
		 
		 lookup.put("ICMP", Protocol.ICMP);
		 lookup.put("UDP", Protocol.UDP);
		 lookup.put("TCP", Protocol.TCP);
