...
//import dimes.gui.registration.ProgressMonitorComponent;
//import dimes.gui.registration.UpdateDetailsParentFrame;
 ...
 */
@Deprecated
public class UpdateDetailsThread extends Thread // implements CancelInputListener - no input listerer because user can't cancel this -bh
{
...
//	ProgressMonitorComponent regMonitor;
	...
	private UpdateDetailsStatus generalRequest = null;
...
//		regMonitor = regMonitorPanel;
	...
	public void run()
	{
		...
		UpdateDetailsStatus updateStat = new UpdateDetailsStatus();
		do
		{
...
//		updateFrame.returnUpdateState(updateStat);
	 ...
	 * @param errorMessages
	 */
	public void startGeneralUpdate(UpdateDetailsStatus updateRequest, Vector successMessages, Vector errorMessages)
	{
