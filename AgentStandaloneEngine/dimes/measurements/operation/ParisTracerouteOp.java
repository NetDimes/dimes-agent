 ...
 * @author galina
 */
public class ParisTracerouteOp extends MeasurementOp
{
	String hostIP;
	int protocol;
	public static short sourcePort; //unix default
	 ...
	 * @deprecated
	 */
	public ParisTracerouteOp(String anIP, Task task)
	{
		super(task);
	 ...
	 * @param task
	 */
	public ParisTracerouteOp(String anIP, int aProtocol, short aSourcePort, short aDestPort, Task task)
	{
		super(task);
		// TODO Auto-generated constructor stub
		hostIP = anIP;
