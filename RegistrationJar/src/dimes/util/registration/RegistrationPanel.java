...
import registration.TestRunner;
...
public class RegistrationPanel extends JPanel  implements UpdateDetailsParentFrame, RegisterDetailsParentFrame//, InstallerScreen 
{
	private Registrator AFF;
	...
	protected ProxyDialog proxyDialog = new ProxyDialog();
	...
	private static final String REGISTRATION_SUCCESS_HTML_LABEL = "<html>" + "<body>" + "<p align=\"left\">" + "<font color=#113355 face=\"Arial\" size=\"4\">"
			+ " Registration commited succesfuly. </font>" + "<br>" + "<hr size=2 width=\"80%\">" + "<font color=#113311 face=\"Arial\" size=\"4\">"
			+ " Dimes Agent version 0.6 was successfuly registered.<br>"+ "</font>" + "</p>" + "</body>" + "</html>";
...
//	private AgentFrameFacade myParentAgentFrame;
	 ...
	 * @since 0.5.0
	 */
	public RegistrationPanel(StandardCommunicator comm, boolean agentIDAlreadyExist, Registrator theAgent) {
	 ...
	 */
	public RegistrationPanel(Registrator frame, StandardCommunicator comm, boolean agentIDAlreadyExist)
	{
...
//		super("Dimes Registration");
		...
		{
			this.currentScreen = RegistrationPanel.INFORM_OLD_USER_VALIDATION_SCREEN;
			try
			{
			...
			catch (NoSuchPropertyException e)
			{
				...
				this.currentScreen = RegistrationPanel.USER_DECISION_SCREEN;
			}
		}
	...
	public void jbInit()
	{
		...
		screen1.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		whyIsThatImportantButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				JOptionPane.showMessageDialog(RegistrationPanel.this, new InfoDisplayPanel(WHY_IS_THAT_IMPORTANT_MESSAGE), "Users and Agents",
		...
		screen2.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		screen2MessagePanel.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		this.whyIsItRequiredButton = new JRadioButton(RegistrationPanel.WHY_IS_THAT_REQUIRED_QUESTION, helpIcon);
		...
		whyIsItRequiredButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				JOptionPane.showMessageDialog(RegistrationPanel.this, new InfoDisplayPanel(WHY_IS_THAT_REQUIRED_MESSAGE),
		...
		usernameLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
...

		{
			...
			try
			{
				...
				if (PropertiesBean.isValidValue(countriesFile))
					countries = RegistrationPanel.getListFromXml(countriesFile);
		...
		countryTextLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		countryTextLabel.setLabelFor(countryComboBox);
		countryTextLabel.setText(RegistrationPanel.COUNTRY_LABEL);
		...
		emailTextLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		emailTextLabel.setLabelFor(emailTextField);
		emailTextLabel.setText(RegistrationPanel.EMAIL_LABEL);
		...
		passwordTextLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		passwordTextLabel.setLabelFor(passwordTextField);
		passwordTextLabel.setText(RegistrationPanel.PASSWORD_LABEL);

		//        JLabel whyIsItRequired = new JLabel(RegistrationPanel.WHY_IS_THAT_REQUIRED_QUESTION);
		...
		screen3.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		screen3MessagePanel.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		iNeverHadPasswordButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				JOptionPane.showMessageDialog(RegistrationPanel.this, new InfoDisplayPanel(I_NEVER_HAS_A_PASSWORD_MESSAGE), "Users Information",
						JOptionPane.PLAIN_MESSAGE);
			}
...
//		oldUsernameTextField.setBackground(SystemColor.inactiveCaptionText);
		...
		oldUsernameLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		...
		confirmPasswordTextLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		confirmPasswordTextLabel.setLabelFor(passwordConfirmTextField);
		confirmPasswordTextLabel.setText(RegistrationPanel.CONFIRM_PASSWORD_LABEL);
...
//		screen4.show();  derecated
		...
		screen4AgentMessagePanel.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		enterAgentDetailsLabel1.setForeground(RegistrationPanel.HEADER_TEXT_COLOR);
		...
		agentNameTextField.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		agentNameLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		...
		screen5.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		enterGroupDetailsLabel1.setForeground(RegistrationPanel.HEADER_TEXT_COLOR);
		...
		this.whyIsGroupsRequiredButton = new JRadioButton(RegistrationPanel.WHATS_THIS_GROUPS_THING_QUESTION, helpIcon);
		...
		whyIsGroupsRequiredButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				JOptionPane.showMessageDialog(RegistrationPanel.this, new InfoDisplayPanel(WHATS_THIS_GROUPS_THING_MESSAGE), "Groups! just join them.",
						JOptionPane.PLAIN_MESSAGE);
			}
		});
		...
		groupTextField.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		groupLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		...
		existingGroupRadioButton.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		existingGroupRadioButton.setOpaque(false);
		existingGroupRadioButton.setText(EXISTING_GROUP_LABEL);

		createGroupRadioButton.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		...
		successPanel.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		successPanel.add(new JLabel(REGISTRATION_SUCCESS_HTML_LABEL));
...
//				proxyDialog.show();
		...
		screen6.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		//  user details without password :
		screen7.setBackground(RegistrationPanel.BACKGROUND_COLOR);
...
//		screen7.show();
		...
		screen7MessagePanel.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		this.whatAreAllThoseNamesButton = new JRadioButton(RegistrationPanel.WHAT_ARE_ALL_THOSE_NAMES_QUESTION, helpIcon);
		...
		whatAreAllThoseNamesButton.addActionListener(new ActionListener()
		{
			...
			{
				whyIsItRequiredButton.setSelected(false);
				JOptionPane.showMessageDialog(RegistrationPanel.this, new InfoDisplayPanel(WHAT_ARE_ALL_THOSE_NAMES_MESSAGE), "Users Information",
						JOptionPane.PLAIN_MESSAGE);
			}
		...
		validationAgentnameLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		...
		validationUsernameLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		...
		validationCountryTextLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		validationCountryTextLabel.setLabelFor(validationCountryComboBox);
		validationCountryTextLabel.setText(RegistrationPanel.COUNTRY_LABEL);
		...
		validationEmailTextLabel.setForeground(RegistrationPanel.OPTION_TEXT_COLOR);
		validationEmailTextLabel.setLabelFor(validationEmailTextField);
		validationEmailTextLabel.setText(RegistrationPanel.EMAIL_LABEL);
		...
		//  agent names:    
		veteranAgentsScreen.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		veteranAgentsScreenMessagePanel.setBackground(RegistrationPanel.BACKGROUND_COLOR);
		...
		nextPrevOptions.setBackground(RegistrationPanel.NEXT_BACK_PANEL_BACKGROUND_COLOR);
...
//		else
		this.theRegistrator.applyRegistrationSuccess(null);
...
//		writeRegistrationDetails(regStat);
	...
	protected void prevRegistrationPhase()
	{
		...
		{
			case RegistrationPanel.USER_DECISION_SCREEN :
				// Do nothing...
				break;

			case RegistrationPanel.NEW_USER_DETAILS_SCREEN :
				currentScreen = RegistrationPanel.USER_DECISION_SCREEN;
				break;

			case RegistrationPanel.VETERAN_USER_DETAILS_SCREEN :
				currentScreen = RegistrationPanel.USER_DECISION_SCREEN;
				this.veteranAgent = false;
				break;

			case RegistrationPanel.AGENT_DETAILS_SCREEN :
				// Do nothing...
				break;
			case RegistrationPanel.GROUP_DETAILS_SCREEN :
				currentScreen = RegistrationPanel.AGENT_DETAILS_SCREEN;
				break;
			case RegistrationPanel.REGISTRATION_SUCCESS_SCREEN :
				currentScreen = RegistrationPanel.GROUP_DETAILS_SCREEN;
				break;
			case RegistrationPanel.VALIDATION_SUCCESS_SCREEN :
				currentScreen = RegistrationPanel.VALIDATION_RESULT_SCREEN;
			case RegistrationPanel.VETERAN_AGENTS_SCREEN :
				currentScreen = RegistrationPanel.VETERAN_USER_DETAILS_SCREEN;
	...
	private void rearangeGUI()
	{
		...
		switch (this.currentScreen)
		{
			...
			/*   Validation screens :   */
			case RegistrationPanel.INFORM_OLD_USER_VALIDATION_SCREEN :
				this.nextButton.setEnabled(true);
				this.prevButton.setEnabled(false);
			...
			case RegistrationPanel.VALIDATION_RESULT_SCREEN :
				this.nextButton.setEnabled(true);
	...
	{
		this.removeAll();
		this.add(newScreen, BorderLayout.CENTER);
		this.validate();
		this.repaint();
	}
	...
	private void moveToScreen(JPanel newScreen)
	{
		this.removeAll();
		this.add(newScreen, BorderLayout.CENTER);
		this.add(nextPrevOptions, BorderLayout.SOUTH);
	}
	...
	private void nextRegistrationPhase()
	{
		...
		switch (this.currentScreen)
		{
			...
			case RegistrationPanel.USER_DECISION_SCREEN :
				...
				{
					currentScreen = RegistrationPanel.NEW_USER_DETAILS_SCREEN;
				}
			...
			case RegistrationPanel.NEW_USER_DETAILS_SCREEN :
			{
				...
				else
				{
					...
					currentScreen = RegistrationPanel.NEW_USER_REGISTRATION_PROGRESS_SCREEN;
				}
			}
				break;
			...
			case RegistrationPanel.VETERAN_USER_DETAILS_SCREEN :
			{
				...
				if (this.oldUsernameTextField.getText().equals(""))
				{
					...
					if (!this.veteranAgent)
					{
						...
						currentScreen = RegistrationPanel.VETERAN_USER_REGISTRATION_PROGRESS_SCREEN;
					}
					else
					//veteran agent
					{
			...
			case RegistrationPanel.VETERAN_AGENTS_SCREEN :
			{
				...
				else
				{
					...
					currentScreen = RegistrationPanel.VETERAN_AGENT_REGISTRATION_PROGRESS_SCREEN;
				}
			}
				break;
			...
			case RegistrationPanel.AGENT_DETAILS_SCREEN :
			{
				...
				if (this.agentNameTextField.getText().equals(""))
				{
					...
					if (!agentName.equals(this.agentNameTextField.getText()))
					{
						...
						currentScreen = RegistrationPanel.AGENT_NAME_UPDATE_PROGRESS_SCREEN;
					}
					else
						currentScreen = RegistrationPanel.GROUP_DETAILS_SCREEN;
			}
			...
			case RegistrationPanel.GROUP_DETAILS_SCREEN :
			{
				...
				if (!groupAction.equals("nop"))
				{
					if (!this.groupTextField.getSelectedItem().equals(""))
					{
						...
						currentScreen = RegistrationPanel.GROUP_UPDATE_PROGRESS_SCREEN;
					}
					else
					{
					...
					currentScreen = RegistrationPanel.REGISTRATION_SUCCESS_SCREEN;
...
//				else
					theRegistrator.applyRegistrationSuccess(null);
//				this.dispose();
				break;
			...
			case RegistrationPanel.INFORM_OLD_USER_VALIDATION_SCREEN :
			{
				...
				currentScreen = RegistrationPanel.VALIDATION_PROGRESS_SCREEN;
				break;
			}
			...
			case RegistrationPanel.VALIDATION_RESULT_SCREEN :
			{
				...
				if (updateRequest != null)
				{
					...
					currentScreen = RegistrationPanel.VALIDATION_RESULT_PROGRES_SCREEN;
				}
				else
					currentScreen = RegistrationPanel.VALIDATION_SUCCESS_SCREEN;
				break;
			}
	...
	public void returnUpdateState(PropertiesStatus updateStat)
	{
		...
		if (updateStat.errorMessage != null || !updateStat.errorMessages.isEmpty())
		{
			...
			if (this.currentScreen == RegistrationPanel.AGENT_NAME_UPDATE_PROGRESS_SCREEN)
			{
				this.screen4ErrorMessage.setText(updateStat.errorMessage);
				this.currentScreen = RegistrationPanel.AGENT_DETAILS_SCREEN;
			}
			if (this.currentScreen == RegistrationPanel.GROUP_UPDATE_PROGRESS_SCREEN)
			{
				this.screen5ErrorMessage.setText(updateStat.errorMessage);
				this.currentScreen = RegistrationPanel.GROUP_DETAILS_SCREEN;
			}
			if (this.currentScreen == RegistrationPanel.VALIDATION_RESULT_PROGRES_SCREEN)
			{
				this.screen7ErrorMessage.setText(updateStat.errorMessage);
				this.currentScreen = RegistrationPanel.VALIDATION_RESULT_SCREEN;
			}
		...
		else
		{
			if (updateStat.updateCanceled)
			{
				...
				if (this.currentScreen == RegistrationPanel.VALIDATION_PROGRESS_SCREEN)
				{
					this.currentScreen = RegistrationPanel.INFORM_OLD_USER_VALIDATION_SCREEN;
				}
				if (this.currentScreen == RegistrationPanel.VALIDATION_RESULT_PROGRES_SCREEN)
			...
			/*********   update success        ********/
			{
				...
				if (this.currentScreen == RegistrationPanel.GROUP_UPDATE_PROGRESS_SCREEN)
				{
					...
					this.currentScreen = RegistrationPanel.REGISTRATION_SUCCESS_SCREEN;
				}
	...
	public void returnRegistrationState(PropertiesStatus regStat)
	{
		...
		if (regStat.errorMessage != null)
		{
			...
			if (this.currentScreen == RegistrationPanel.NEW_USER_REGISTRATION_PROGRESS_SCREEN)
			{
				this.screen2ErrorMessage.setText(regStat.errorMessage);
				this.currentScreen = RegistrationPanel.NEW_USER_DETAILS_SCREEN;
			}
			if (this.currentScreen == RegistrationPanel.VETERAN_USER_REGISTRATION_PROGRESS_SCREEN)
			{
				this.screen3ErrorMessage.setText(regStat.errorMessage);
				this.currentScreen = RegistrationPanel.VETERAN_USER_DETAILS_SCREEN;
			}
			if (this.currentScreen == RegistrationPanel.VETERAN_AGENT_REGISTRATION_PROGRESS_SCREEN)
			{
				...
				this.currentScreen = RegistrationPanel.VETERAN_AGENTS_SCREEN;
			}
		}
...
/*	@Override
	public JComponent createComponent() {
		AFF = Registrator.getInstance(context.getInstallationDirectory().getPath()+File.separator+"Agent"+File.separator+"Classes"+File.separator+"Base"+File.separator+"conf"+File.separator+"properties.xml");
		SC = TestRunner.getPropertiesUpdateCommunicator();
		return new RegistrationPanel(AFF, SC, false);
	}
	@Override
